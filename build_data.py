...
tf.flags.DEFINE_string('X_input_dir', 'data/edgetosaree/trainA',
                       'X input directory, default: data/edgetosaree/trainA')
tf.flags.DEFINE_string('Y_input_dir', 'data/edgetosaree/trainB',
                       'Y input directory, default: data/edgetosaree/trainB')
tf.flags.DEFINE_string('X_output_file', 'data/tfrecords/edge.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/edge.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'data/tfrecords/saree.tfrecords',
                       'Y output tfrecords file, default: data/tfrecords/saree.tfrecords')
