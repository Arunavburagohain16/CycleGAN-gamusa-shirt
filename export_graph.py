...
tf.flags.DEFINE_string('XtoY_model', 'edge2saree.pb', 'XtoY model name, default: edge2saree.pb')
tf.flags.DEFINE_string('YtoX_model', 'saree2edge.pb', 'YtoX model name, default: saree2edge.pb')
